...
#         if not self.pk and DsrcConfig.objects.exists():
#             raise ValidationError("There can be only one DsrcBaseSettings instance")
#         return super(DsrcConfig, self).save(*args, **kwargs)
