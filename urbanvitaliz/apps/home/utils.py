...
def make_new_site(name: str, domain: str, sender_email: str, sender_name: str) -> Site:
    ...
    onboarding = onboarding_models.Onboarding.objects.create(site=site)
    ...
    # Create staff/admin/advisors groups
    # TODO create util function that return f"{domain}_staff"
    group = auth_models.Group.objects.create(name)
