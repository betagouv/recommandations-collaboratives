...
def deploy(cnx):
    ...
    cnx.put(
        "./dist/urbanvitaliz-django-0.2.0.tar.gz",
        remote="./urbanvitaliz-site/dist/urbanvitaliz-django-0.2.0.tar.gz",
    )
    cnx.run(
        "cd urbanvitaliz-site "
        "&& ./venv/bin/pip install ./dist/urbanvitaliz-django-0.2.0.tar.gz"
        "&& ./manage.py migrate"
