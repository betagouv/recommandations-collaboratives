...
const LAT_LNG_FRANCE = [46.5, 1.2]; // latitude and longitude of centroid of France
...
async function fetchParcelsIgn(insee) {
  ...
  const parcels = await fetch(
    apiEndpoint + new URLSearchParams(searchParams)
