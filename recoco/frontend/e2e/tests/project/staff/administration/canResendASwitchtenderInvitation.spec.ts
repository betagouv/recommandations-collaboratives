...
test.describe(
  'I can go to administration area of a project and send back an invite for a switchtender',
  ...
  () => {
    ...
    test('goes to the administration tab of a project and send back the switchtender invitation', async ({
      page,
    }) => {
      ...
      await page
        ...
        .locator('#resend-invite-switchtender')
        .first()
        .click({ force: true });
