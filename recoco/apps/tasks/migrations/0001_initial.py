...
import recoco.apps.tasks.models
import uuid
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "content",
                            models.TextField(default="", verbose_name="Contenu"),
                        ),
                    ...
                    managers=[
                        ...
                        ("on_site", recoco.apps.tasks.models.TaskOnSiteManager()),
                        (
                            "deleted_on_site",
                            recoco.apps.tasks.models.DeletedTaskOnSiteManager(),
                        ),
                    ],
                ),
                migrations.CreateModel(
                    ...
                    managers=[
                        ...
                        (
                            "on_site",
                            recoco.apps.tasks.models.TaskRecommendationOnSiteManager(),
                        ),
                    ],
                ),
                migrations.CreateModel(
            ...
            database_operations=[
                migrations.RunSQL(
                    "ALTER TABLE projects_task RENAME TO tasks_task",
                    reverse_sql="ALTER TABLE tasks_task RENAME TO projects_task",
                ),
                migrations.RunSQL(
                    "ALTER TABLE projects_taskfollowup RENAME TO tasks_taskfollowup",
                    reverse_sql="ALTER TABLE tasks_taskfollowup RENAME TO projects_taskfollowup",
                ),
                migrations.RunSQL(
                    "ALTER TABLE projects_taskfollowuprsvp RENAME TO tasks_taskfollowuprsvp",
                    reverse_sql="ALTER TABLE tasks_taskfollowuprsvp RENAME TO projects_taskfollowuprsvp",
                ),
                migrations.RunSQL(
                    "ALTER TABLE projects_taskrecommendation RENAME TO tasks_taskrecommendation",
                    reverse_sql="ALTER TABLE tasks_taskrecommendation RENAME TO projects_taskrecommendation",
                ),
                migrations.RunSQL(
